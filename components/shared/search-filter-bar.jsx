...
function ControlShell({ children }) {
  return (
    <div className="rounded-[22px] border border-slate-200/80 bg-white/90 px-3 py-2 shadow-[0_18px_34px_-26px_rgba(15,23,42,0.45)] backdrop-blur-sm">
      {children}
    </div>
  );
}
...
export default function SearchFilterBar({
  ...
  return (
    <section className="panel-surface overflow-hidden p-0">
      <div className="flex flex-wrap items-center justify-between gap-3 border-b border-slate-200/80 bg-[linear-gradient(135deg,rgba(15,23,42,0.98),rgba(30,41,59,0.95))] px-4 py-3 text-white lg:px-5">
        <div>
      ...
      <div className="grid gap-3 bg-[linear-gradient(180deg,rgba(255,255,255,0.35),transparent)] p-4 lg:grid-cols-[minmax(0,1.6fr)_220px_220px] lg:p-5">
        <ControlShell>
