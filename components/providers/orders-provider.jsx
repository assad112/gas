...
function getMessages(locale) {
  return locale === "en"
    ? {
        ...
        productsLoadError: "Unable to load pricing data right now.",
        ...
        productSaved: "Pricing updated successfully.",
        productSaveError: "Unable to update this pricing row.",
    ...
    : {
        ...
        productsLoadError: "تعذر تحميل بيانات التسعير الآن.",
        ...
        productSaved: "تم تحديث بيانات التسعير.",
        productSaveError: "تعذر تحديث هذا السطر من التسعير.",
