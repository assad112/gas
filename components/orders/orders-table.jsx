...
function InfoChip({ icon: Icon, label, value }) {
  return (
    <div className="rounded-2xl border border-slate-100 bg-[linear-gradient(180deg,rgba(248,250,252,0.88),rgba(255,255,255,0.96))] p-3 shadow-[0_18px_28px_-28px_rgba(15,23,42,0.45)]">
          ...
          return (
            <article
              ...
              className={cn(
                ...
                isSelected
                  ? "border-brand-300 bg-[linear-gradient(180deg,rgba(255,247,237,0.95),rgba(255,255,255,0.98))] shadow-[0_24px_46px_-32px_rgba(14,116,144,0.45)]"
                  : "border-slate-100 bg-[linear-gradient(180deg,rgba(255,255,255,0.95),rgba(248,250,252,0.96))] shadow-[0_18px_34px_-30px_rgba(15,23,42,0.24)] hover:-translate-y-0.5 hover:border-brand-200 hover:bg-brand-50/30"
              )}
            >
