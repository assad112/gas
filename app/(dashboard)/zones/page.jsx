...
export default function ZonesPage() {
  const { zones, resources, refreshZones, saveZone, zoneMutationIds } =
    useAdmin();
    ...
    <div className="space-y-6">
      <section className="panel-surface p-6 lg:p-8">
        ...
        <p className="mt-2 max-w-3xl text-sm leading-7 text-slate-500">
          {locale === "en"
            ? "Control delivery fees, ETA, activation state, and operational notes for Muscat, Al Khuwair, Al Seeb, Sohar, Salalah, and any future zones."
            : "تحكم في رسوم التوصيل والوقت المتوقع وحالة التفعيل والملاحظات التشغيلية لمسقط والخوير والسيب وصحار وصلالة وأي مناطق مستقبلية."}
        </p>
      </section>
      ...
      {zones.length === 0 ? (
        ...
        <ZonesTable zones={zones} savingIds={zoneMutationIds} onSave={saveZone} />
      )}
    </div>
  );
}
